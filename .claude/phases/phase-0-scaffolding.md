...
- Vendored `reference/better-auth/` @ pinned tag; `port/UPSTREAM_PORTED` baseline SHA.
...
- `.github/` ported 1:1 (templates, CODEOWNERS, security workflows, release-plz, ci/e2e skeleton).
- pnpm workspace scoped to `docs/` + reference server; `docker-compose.yml`; root meta docs
